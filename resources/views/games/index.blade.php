...
@section('content')
    <div class="container">
        ...
        <div class="overflow-hidden">
            <h3 class="mt-4 h5 font-weight-bold float-right"><i class="fas fa-chart-bar fa-lg mr-2"></i>جدول برترین های مسابقات{{ $month > 0 ? (' - ماه ' . month_name($m)) . ' ' . persian_numbers($y) : '' }}</h3>
        </div>
        <hr class="mt-0">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6 col-lg-4 order-0 order-lg-0">
                        <a class="btn btn-block {{ $month == date('Ym') ? 'btn-success' : 'btn-secondary' }}" href="{{ route('games', ['d' => date('Ym')]) }}">برترین‌های این ماه</a>
                    </div>
                    ...
                    <div class="col-6 col-lg-4 order-1 order-lg-2">
                        <a class="btn btn-block {{ $month == $last_month ? 'btn-success' : 'btn-secondary' }}" href="{{ route('games', ['d' => $last_month]) }}">برترین‌های ماه قبل</a>
                    </div>
                </div>
